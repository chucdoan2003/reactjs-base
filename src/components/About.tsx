...
const About=()=>{
    return (
        <>
         <div className="about bg-gray-900 text-white flex flex-row flex-wrap justify-between px-14 pt-4 max-[888px]:justify-center" id="home">
            <div className="about-content">
                <p className=" text-xl font-bold">Hello, It's Me</p>
                <p className="text-6xl font-bold my-2">Đoàn Bá Chúc</p>
            ...
            <div className="about-avt">
                <div className="rounded-full bg-cyan-400 w-96 h-96 overflow-hidden">
